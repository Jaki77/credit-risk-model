...
def sample_transaction_data():
    ...
    data = {
        ...
        'ProductCategory': np.random.choice(['tv', 'airtime', 'rata_bundles', 'transport'], 100),
        'ProviderId': np.random.choice(['ProviderId_1', 'ProviderId_2', 'ProviderId_3', 'ProviderId_4'], 100),
...
def test_calculate_rfm(data_processor, sample_transaction_data):
    ...
    assert rfm_df['CustomerId'].nunique() == sample_transaction_data['CustomerId'].nunique()
...
def test_create_temporal_features(data_processor, sample_transaction_data):
    ...
    # Check customer count
    assert temporal_features['CustomerId'].nunique() == processed['CustomerId'].nunique()
